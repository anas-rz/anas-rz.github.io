...
**Projects**
* **K3IM: Keras 3 Image Models** Implementation of more than Image Models  and their 1D/3D/Space-Time extensions in Keras 3 \(more than 30 in total\). The models have been trained and tested with TensorFlow, PyTorch and JAX backends. ([repo](https://github.com/anas-rz/k3im/))
